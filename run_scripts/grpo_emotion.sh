...
data_path2="$home_dir/emotion_dataset/DISFA-Train-3-gpt.jsonl"
data_path3="$home_dir/emotion_dataset/RAF-AU-Train.jsonl"
data_path4="$home_dir/emotion_dataset/FER2013-Train-1000-gpt.jsonl"
data_path5="$home_dir/emotion_dataset/AffectNet-Train-1000-gpt.jsonl"
data_path6="$home_dir/emotion_dataset/RAF-DB-Train-1000-gpt.jsonl"
